$(document).ready(()=>{
  ...
  var loadQuestions = function() {
    ...
    if (questions) {
      ...
      window.location.href='../html/generateQuiz.html'
    }
  };
  ...
  $('#submit').on('click',()=>{
    ...
    if(selectedQuestions.length==0) {
      ...
      //make ajax request.....
      $.ajax({
        url:'http://2be99f2f9caf.ngrok.io/api/teacher/updateTeacherAndStudentQuiz?teacherId='+teacherId+'&studentId='+studentId+'&queryId='+queryId,
        type:'POST',
        dataType: 'json',
